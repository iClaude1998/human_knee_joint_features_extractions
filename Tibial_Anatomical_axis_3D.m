function [xfit,yfit,zfit]=Tibial_Anatomical_axis_3D(tibia)
Anaomical_axis=[];
for i=1:856
    [labeledImage, numberOfBlobs] = bwlabel(tibia(:,:,i),8);
...
Anaomical_axis_x=Anaomical_axis(1:360,1)';
Anaomical_axis_y=Anaomical_axis(1:360,2)';
Anaomical_axis_z=1:360;
